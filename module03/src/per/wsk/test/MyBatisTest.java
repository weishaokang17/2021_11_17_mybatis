...
import per.wsk.dao.DepartmentMapper;
import per.wsk.dao.EmployeeMapper;
import per.wsk.dao.EmployeeMapperAnnotation;
import per.wsk.dao.EmployeeMapperPlus;
	...
	public void test() throws IOException {
		...
		try {
			Employee employee = openSession.selectOne(
					"per.wsk.entity.EmployeeMapper.getEmpById", 1);
